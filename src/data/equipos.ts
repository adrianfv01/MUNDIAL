...
// Las 48 selecciones del Mundial 2026 (USA / Canada / Mexico) tal como aparecen
// en el album oficial Panini FIFA World Cup 2026 (lanzado el 29 de abril de 2026).
// El orden y los grupos (A-L, 4 equipos por grupo) reflejan la disposicion del album.
export const equipos: Equipo[] = [
  ...
  { codigo: 'RSA', nombre: 'Sudafrica', grupo: 'A', confederacion: 'CAF', colorPrimario: '#007749', colorSecundario: '#FFB915', bandera: 'ZA', estado: 'clasificado' },
  ...
  { codigo: 'CZE', nombre: 'Republica Checa', grupo: 'A', confederacion: 'UEFA', colorPrimario: '#11457E', colorSecundario: '#D7141A', bandera: 'CZ', estado: 'clasificado' },

  // Grupo B
  { codigo: 'CAN', nombre: 'Canada', grupo: 'B', confederacion: 'CONCACAF', colorPrimario: '#FF0000', colorSecundario: '#FFFFFF', bandera: 'CA', estado: 'clasificado' },
  ...
  { codigo: 'HAI', nombre: 'Haiti', grupo: 'C', confederacion: 'CONCACAF', colorPrimario: '#00209F', colorSecundario: '#D21034', bandera: 'HT', estado: 'clasificado' },
  ...
  { codigo: 'TUR', nombre: 'Turquia', grupo: 'D', confederacion: 'UEFA', colorPrimario: '#E30A17', colorSecundario: '#FFFFFF', bandera: 'TR', estado: 'clasificado' },
  ...
  // Grupo F
  { codigo: 'NED', nombre: 'Paises Bajos', grupo: 'F', confederacion: 'UEFA', colorPrimario: '#FF6900', colorSecundario: '#21468B', bandera: 'NL', estado: 'clasificado' },
  ...
  { codigo: 'TUN', nombre: 'Tunez', grupo: 'F', confederacion: 'CAF', colorPrimario: '#E70013', colorSecundario: '#FFFFFF', bandera: 'TN', estado: 'clasificado' },

  // Grupo G
  { codigo: 'BEL', nombre: 'Belgica', grupo: 'G', confederacion: 'UEFA', colorPrimario: '#ED2939', colorSecundario: '#FAE042', bandera: 'BE', estado: 'clasificado' },
  ...
  { codigo: 'IRN', nombre: 'Iran', grupo: 'G', confederacion: 'AFC', colorPrimario: '#239F40', colorSecundario: '#DA0000', bandera: 'IR', estado: 'clasificado' },
  ...
  // Grupo H
  { codigo: 'ESP', nombre: 'Espana', grupo: 'H', confederacion: 'UEFA', colorPrimario: '#AA151B', colorSecundario: '#F1BF00', bandera: 'ES', estado: 'clasificado' },
  ...
  { codigo: 'UZB', nombre: 'Uzbekistan', grupo: 'K', confederacion: 'AFC', colorPrimario: '#1EB53A', colorSecundario: '#0099B5', bandera: 'UZ', estado: 'clasificado' },
  ...
  { codigo: 'PAN', nombre: 'Panama', grupo: 'L', confederacion: 'CONCACAF', colorPrimario: '#DA121A', colorSecundario: '#005AA7', bandera: 'PA', estado: 'clasificado' },
]
